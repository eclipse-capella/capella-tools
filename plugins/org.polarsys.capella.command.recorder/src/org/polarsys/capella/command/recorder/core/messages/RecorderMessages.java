 ...
 *******************************************************************************/
package org.polarsys.capella.command.recorder.core.messages;
...
public class RecorderMessages extends NLS {
  private static final String BUNDLE_NAME = CapellaCommandRecorderActivator.getDefault().getPluginId() + ".messages.messages"; //$NON-NLS-1$
